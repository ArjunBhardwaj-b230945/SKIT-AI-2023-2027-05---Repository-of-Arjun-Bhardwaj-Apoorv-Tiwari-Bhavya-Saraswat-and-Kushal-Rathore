...
def get_repo_info():
    """Extract the repository name and current Git branch."""
...
def create_charts(
    ...
    """Generate visual workload and trend charts."""
    ...
    if authors:
        ...
        # Repeat colors if there are more than 5 students
        bar_colors = [
...
def generate_pdf(interval="weekly"):
    ...
    mentor_cell = [
        Paragraph(
            "<b>Name:</b> ______________________________",
            sig_block_style,
        ),
        Paragraph(
